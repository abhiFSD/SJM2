<!-- files related to the file upload start here-->
...
<!-- files related to the file upload end here-->
<div id="dialog_upload_product_images_form" title="Upload Item Images">	
	<!-- upload plugin starts here-->
    ...
    <form id="fileupload" action="//jquery-file-upload.appspot.com/" method="POST" enctype="multipart/form-data">
        ...
        <table role="presentation" class="table table-striped" id="upload_table"><tbody class="files"></tbody></table>
    </form>
...
<script src="<?php echo base_url(); ?>assets/jQuery-File-Upload/js/jquery.fileupload-ui.js"></script>
<!-- The main application script -->
<script src="<?php echo base_url(); ?>assets/jQuery-File-Upload/js/main.js"></script>
